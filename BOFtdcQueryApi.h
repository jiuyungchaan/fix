...
#ifndef __BO_FTDCQUERYAPI_H__
#define __BO_FTDCQUERYAPI_H__
...
class BOFtdcQueryApi
{
public:
	///创建QueryApi
	///@param pszFlowPath 存贮订阅信息文件的目录，默认为当前目录
	///@return 创建出的UserApi
	static BOFtdcQueryApi *CreateFtdcQueryApi(const char *pszFlowPath = "");
	...
	virtual void RegisterSpi(BOFtdcQuerySpi *pSpi) = 0;
