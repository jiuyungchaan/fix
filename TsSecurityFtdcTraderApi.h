...
#ifndef __TSSECURITY_FTDCTRADERAPI_H__
#define __TSSECURITY_FTDCTRADERAPI_H__
...
class CTsSecurityFtdcTraderSpi
{
public:
...
class CTsSecurityFtdcTraderApi
{
public:
	///创建TraderApi
	///@param pszFlowPath 存贮订阅信息文件的目录，默认为当前目录
	///@return 创建出的UserApi
	static CTsSecurityFtdcTraderApi *CreateFtdcTraderApi(const char *pszFlowPath = "");
	...
	virtual void RegisterSpi(CTsSecurityFtdcTraderSpi *pSpi) = 0;
